...
public class JwtUtils {
    private static final long EXPIRATION_TIME = 30L * 24L * 60* 60* 1000; //30days to milliseconds
    ...
    public Integer getTokenVersionFromToken(String token) {
        return extractClaims(token, claims -> claims.get("token_version", Integer.class));
    }
}
